...
pub async fn gami_to_furras(token: String, gami: bool) {
    ...
    use prost::Message;
    use serde_json::json;
    use crate::discord::types::protos::discord_protos::discord_users::v1::preloaded_user_settings:: {PreloadedUserSettings,preloaded_user_settings:: {StatusSettings,CustomStatus}};
