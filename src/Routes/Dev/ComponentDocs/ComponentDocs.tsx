    ...
    <StateSetterNew state={'Dev'} force={true}>
      <main class={style.main}>
        <section>
          ...
          <p>
            This is a developer only page for testing and documentation of
            components. If you're looking for information on what a certain
            component does, why it's build in a certain way, what has to be done
            and how it has to be done. It should be here.
          </p>
        </section>
