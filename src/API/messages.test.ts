...
test('Markdown formatting of code block', () => {
	const text = API.Messages.formatMarkdownToString('```code block```');
	expect(text).toBe('<pre class="codeblock">code block</pre>');
});
test('Markdown formatting of 2 code blocks', () => {
	const text = API.Messages.formatMarkdownToString('```code block``` ```code block```');
...
test('Markdown formatting of a list', () => {
	const text = API.Messages.formatMarkdownToString('- list item 1');
