...
export function getGuildIconFromChannel(AppState: AppStateType, channel: Channel): string {
...
export async function updateGuilds(AppState: AppStateType) {
...
export function addAdditionalGuildDataToState(AppState: AppStateType, data: GuildListUpdate) {
