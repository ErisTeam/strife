...
import { CssStringVariableToObject, CssVariables, Units, getVariable } from '../Style';
...
export const StyleEntries: (SettingsEntry | (() => SettingsEntry))[] = [
	() => {
		return {
			...
			defaultValue: getVariable('--chat-bgc'),
			type: 'ColorPicker',
		};
	},
	() => {
		const v = getVariable(CssVariables.Components.Chat.roundness);
		//get numbers
		...
		return {
			...
			units: [...Units.relative.slice(0, 2), 'px'],
	...
	() => {
		return {
			...
			defaultValue: getVariable(CssVariables.Components.Misc.loadingBackground),
			type: 'ColorPicker',
		};
	},
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.Guilds.background),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.Guilds.fallbackBackground),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.Guilds.dividerColor),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.Guilds.tooltipBackground),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.Guilds.beforeBackground),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: CssStringVariableToObject(getVariable(CssVariables.Components.Guilds.width)),
		type: 'CssNumberProperty',
		units: [...Units.relative.slice(0, 2), 'px'],
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.Channels.categoryText),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.Channels.iconColor),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.Channels.iconBackground),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: CssStringVariableToObject(getVariable(CssVariables.Components.Channels.categoryRoundness)),
		type: 'CssNumberProperty',
		units: [...Units.relative.slice(0, 2), 'px'],
	}),
	() => ({
		...
		defaultValue: CssStringVariableToObject(getVariable(CssVariables.Components.WindowDecoration.height)),
		type: 'CssNumberProperty',
		units: [...Units.relative.slice(0, 2), 'px'],
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.Components.WindowDecoration.background),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth0),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth1),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth2),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth3),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth4),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth5),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth6),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth7),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth8),
		type: 'ColorPicker',
	}),
	() => ({
		...
		defaultValue: getVariable(CssVariables.BaseColors.depth9),
		type: 'ColorPicker',
	}),
];
