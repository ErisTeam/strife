...
import type {
  SettingsEntry as SettingsEntryType,
  SettingsGroup,
} from './SettingsTypes';
import { useAppState } from '../../AppState';
import { SettingsEntryElement } from './SettingsEntry';
import style from './Settings.module.css';

export function SettingsGroupElement(props: { group: SettingsGroup }) {
      ...
      <For each={options()}>
        {(entry) =>
          entry.index === -1 ? (
            ...
            <SettingsEntryElement setting={entry.entry} index={entry.index} />
          )
        }
      </For>
    </section>
