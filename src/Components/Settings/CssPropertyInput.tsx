...
import type { CssPropertyType } from './SettingsTypes';
import inputs from '../../Styles/Inputs.module.css';

export function CssPropertyInput(props: {
  value: CssPropertyType;
  units: string[];
  onChange?: (value: CssPropertyType) => void;
}) {
  return (
    <section class={inputs.default}>
      <input
        ...
        oninput={(e) =>
          props.onChange({
            value: Number.parseInt((e.target as HTMLInputElement).value),
