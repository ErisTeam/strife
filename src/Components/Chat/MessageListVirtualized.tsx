...
import { type Accessor, For, Resource, type Setter } from 'solid-js';
import type {
  MessageReference,
...
export function MessageListVirtualized(props: MessageListVirtualizedProps) {
              ...
              if (props.messages()[virtualRow.index].message_reference) {
                msgRef = props
                  ...
                  .find(
                    (msg) =>
                      msg.id ===
                      props.messages()[virtualRow.index].message_reference
                        .message_id
                  );
              }
              const same =
                props.messages()[virtualRow.index].author.id === lastAuthor;
              if (!same) {
