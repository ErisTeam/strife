...
import type { Embed as EmbedType } from '../../types/Messages';
        ...
        >
          ...
          <Show when={props.embed.author}>
            <header class={style.author}>
              {props.embed.author.icon_url && (
                <img
                  src={props.embed.author.icon_url}
          ...
          <Switch>
            <Match when={props.embed.url}>
              <a class={`${style.title} mdLink`} href={props.embed.url}>
                {props.embed.title}
              </a>
            </Match>
          ...
          {props.embed.description && (
            <p class={style.description}>
              {formatMarkdownToHTML(props.embed.description)}
            </p>
          )}
          ...
          {props.embed.footer && (
            <footer>
              {props.embed.footer.icon_url && (
                <img
                  src={props.embed.footer.proxy_icon_url}
                  alt={props.embed.url}
                />
              )}
              ...
              {props.embed.timestamp && (
                <time>
                  {dateFormater.format(new Date(props.embed.timestamp))}
                </time>
              )}
            </footer>
          )}
