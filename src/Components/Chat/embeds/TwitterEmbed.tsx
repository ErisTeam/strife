  ...
  return (
    <article class={`${style.embed} ${style.twitter}`}>
      ...
      <aside class={style.author}>
        ...
        >
          <img
            src={props.embed.author.proxy_icon_url}
      ...
      <aside class={style.time}>
        <a
          href={props.embed.url}
          title={dateFormater.format(new Date(props.embed.timestamp))}
        >
      ...
      <section class={style.fields}>
        ...
        >
          ...
          {numberFormater.format(Number.parseInt(props.embed.fields[0].value))}
        </a>
        <a
          class={style.reply}
        ...
        >
          ...
          {numberFormater.format(Number.parseInt(props.embed.fields[1].value))}
        </a>
